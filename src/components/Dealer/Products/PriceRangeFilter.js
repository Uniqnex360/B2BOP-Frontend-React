...
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
//   const [priceRange, setPriceRange] = useState({ price_from: 0, price_to: 1000 });
...
//       const responseData = response.data?.data || {};
//       setMaxPrice(responseData.price || 1000); // Set the maximum price from the response
//       setPriceRange((prevState) => ({ price_from: 0, price_to: responseData.price || 1000 })); // Update the price range
//       setCurrency(responseData.currency || "$"); // Default currency if not available
...
//   const handleSliderChange = (event, newValue) => {
//     // Ensure newValue is an array of numbers
...
//       </Typography>
//       <Slider
//         value={[priceRange.price_from, priceRange.price_to]} // Ensure it's an array of two numbers
//         onChange={handleSliderChange}
//         onChangeCommitted={handleSliderChangeCommitted}
//         valueLabelDisplay="auto"
//         min={0}
